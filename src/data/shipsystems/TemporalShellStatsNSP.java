...
public class TemporalShellStatsNSP extends BaseShipSystemScript {
	...
	public static final Color JITTER_COLOR = new Color(236,165,242,55);
	public static final Color JITTER_UNDER_COLOR = new Color(232,135,242,155);
	...
	public void apply(MutableShipStatsAPI stats, String id, State state, float effectLevel) {
		...
		float shipTimeMult = 2f + (MAX_TIME_MULT - 2f) * effectLevel;
...
//		stats.getEmpDamageTakenMult().unmodify(id);
	...
	public StatusData getStatusData(int index, State state, float effectLevel) {
		float shipTimeMult = 1f + (MAX_TIME_MULT - 2f) * effectLevel;
		if (index == 0) {
