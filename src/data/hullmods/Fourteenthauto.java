...
public class Fourteenthauto extends BaseHullMod {
	...
	public void applyEffectsBeforeShipCreation(HullSize hullSize, MutableShipStatsAPI stats, String id) {
		...
		if (Global.getSector().getMemoryWithoutUpdate().getBoolean("$nsp_safeguardRestored") && stats.getVariant() != null && stats.getVariant().hasTag(Tags.VARIANT_UNRESTORABLE)){
			stats.getVariant().removeTag(Tags.VARIANT_UNRESTORABLE);
		}
