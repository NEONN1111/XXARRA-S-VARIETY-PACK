...
import data.plugins.NSP_ExponentCore;
import data.scripts.util.MagicRender;
import data.scripts.util.NSPSandevistan2;
...
import static com.fs.starfarer.api.impl.combat.dweller.ShroudedLensHullmod.DATA_KEY;
...
public class NSPSandyEffect2 extends BaseHullMod {
    ...
    protected void spawnTemporalMote(ShipAPI ship, MoteSystemData moteData) {
        ...
        mote.setMissileAI(new data.shipsystems.NSP_ExponentMoteControl(mote));
