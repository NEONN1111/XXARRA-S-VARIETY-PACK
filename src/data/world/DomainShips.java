package data.world; // NEEDS a package. Must match the class path in your mod. Mine is different, so change this! Right now!
...
import static com.fs.starfarer.api.impl.campaign.ids.Commodities.DOMESTIC_GOODS;
