...
public class NSPOrionDeviceStatsShieldless extends BaseShipSystemScript {
	...
	public void apply(MutableShipStatsAPI stats, String id, State state, float effectLevel) {
		...
		// Replace the existing spawn logic in the apply() method (around lines 118-124)

		// Add this import at the top of the file if not already present:


// Then replace the existing spawn logic in the apply() method (around lines 118-124):
