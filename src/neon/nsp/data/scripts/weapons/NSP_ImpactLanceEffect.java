...
import neon.nsp.data.scripts.util.ActionPlugin;

import java.util.HashSet;
import java.util.Set;

@SuppressWarnings("unused")
public class NSP_ImpactLanceEffect implements EveryFrameWeaponEffectPluginWithAdvanceAfter {
    static final String modificationSource = "nsp_graviton_lance";
