...
public class NSP_AntimatterInjectorOnHitEffect extends BaseCombatLayeredRenderingPlugin implements OnHitEffectPlugin {
	...
	public static int NUM_TICKS = 1;
	public static float TOTAL_DAMAGE = 300;
	
	public NSP_AntimatterInjectorOnHitEffect() {
	}
	...
	public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target, Vector2f point, boolean shieldHit, ApplyDamageResultAPI damageResult, CombatEngineAPI engine) {
		...
		NSP_AntimatterInjectorOnHitEffect effect = new NSP_AntimatterInjectorOnHitEffect(projectile, (ShipAPI) target, offset);
	...
	public static class ParticleData {
		...
		public Color color = new Color(255,100,255,255);
	...
	public NSP_AntimatterInjectorOnHitEffect(DamagingProjectileAPI proj, ShipAPI target, Vector2f offset) {
		this.proj = proj;
		this.target = target;
		this.offset = offset;
	...
	protected void addParticle() {
		ParticleData p = new ParticleData(15f, 3f + (float) Math.random() * 2f, 2f);
		particles.add(p);
