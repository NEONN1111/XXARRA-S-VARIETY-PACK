...
public class NSP_AntimatterInjectorEffect extends CryofluxTransducerEffect {
	...
	public NSP_AntimatterInjectorEffect() {
		super();
	}

	public NSP_AntimatterInjectorEffect(DamagingProjectileAPI projectile, DamagingProjectileAPI prev) {
...
//			Vector2f.add(p.offset, dir, p.offset);
	...
	protected NSP_AntimatterInjectorEffect createTrail(DamagingProjectileAPI projectile, DamagingProjectileAPI prev) {
		return new NSP_AntimatterInjectorEffect(projectile, prev);
	}
	...
	public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target, Vector2f point, boolean shieldHit, ApplyDamageResultAPI damageResult, CombatEngineAPI engine) {
		...
		engine.addNegativeNebulaParticle(pt, v, nSize * 1f, 2f, 0.25f / dur, 0f, dur, c);
	}
