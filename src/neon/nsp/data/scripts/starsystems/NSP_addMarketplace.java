...
//Generic Class to simplify setting up markets on planets in code. Taken from tomatopaste's example starsystem
//Big thanks to tomatopaste for their example <3
public class NSP_addMarketplace {

    public static MarketAPI NSP_addMarketplace(
            String factionID,
