...
public class nsp_legionGen {
    ...
    public static void generate(SectorAPI sector) {
        ...
        system.setOptionalUniqueId("legiogen"); // used to retrieve system later if needed, we don't really need to but i didn't comment this out
        ...
        PlanetAPI rock = system.addPlanet("nsp_rock", null, name, Planets.BARREN, 0, 150, 0, 0);
       ...
       SectorEntityToken legion = createWreckEntity(system, "nsp_legionmk1_ancient", ShipRecoverySpecial.ShipCondition.WRECKED, "Serial 12A183HP9A z Y5ZN", rock, true, true, new Vector2f());
        legion.getMemoryWithoutUpdate().set("$nsp_legionWreck", true); // used for dialog
        legion.setId("nsp_legionWreck");
