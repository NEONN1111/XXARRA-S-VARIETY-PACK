...
public class DMN2 {
    public static Logger log = Global.getLogger(DMN2.class);
    ...
    public static void addDMN(SectorAPI sector){
        ...
        TTBlackSite.addDerelict(targetstar, entity, "nsp_legion_domain_elite", "DMN Into The Fire", "nsp_legion_domain", ShipRecoverySpecial.ShipCondition.PRISTINE, entity.getRadius() +300, true);
        log.info("The DMN Into The Fire is in" + targetstar.getName());
    }
}