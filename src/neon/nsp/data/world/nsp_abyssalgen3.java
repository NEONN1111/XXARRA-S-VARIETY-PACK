...
public class nsp_abyssalgen3 {
    ...
    public static void generate(SectorAPI sector) {
        ...
        system.setName("Deep Space III"); // to get rid of "Star System" at the end of the name
        system.setOptionalUniqueId("onthgen"); // used to retrieve system later if needed, we don't really need to but i didn't comment this out
        ...
        String name = "Nameless Rock 3";

        PlanetAPI rock = system.addPlanet("nsp_threat3", null, name, Planets.BARREN, 0, 150, 0, 0);
