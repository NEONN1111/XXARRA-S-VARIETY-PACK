...
public class nsp_abyssalgen2 {
    ...
    public static void generate(SectorAPI sector) {
        ...
        system.setName("Deep Space II"); // to get rid of "Star System" at the end of the name
        system.setOptionalUniqueId("thromgen"); // used to retrieve system later if needed, we don't really need to but i didn't comment this out
        ...
        String name = "Nameless Rock 2";

        PlanetAPI rock = system.addPlanet("nsp_threat2", null, name, Planets.BARREN, 0, 150, 0, 0);
